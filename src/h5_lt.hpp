    ...
    hsize_t theSize=bufSize;
        ...
        { 
            case H5T_STRING:
            {
                ...
                if (ndims == 0)
                {
                    // This dataset has a SCALAR dataspace (just a single string)
                ...
                {
                    // This dataset has a SIMPLE dataspace (a multi-dimensional array of strings)
                    ...
                    else
                    {
                        ...
                        int allocateSize = dimSizes[0] * (stringSize + 1) * sizeof(char);
                        rawStrings[0] = new char[allocateSize];
